...
export const ui = {
  en: {
    ...
    'home.hero.tagline': 'This is my personal blog about whatever interests me — code, design, automation, and whatever lands in between. Sometimes I use the blog as a notebook and interesting stuff gets written down by my robot coworker Bender, with a Minimax brain.',
  ...
  hu: {
    ...
    'home.hero.tagline': 'Ez a személyes blogom, az engem érdeklő aktuális dolgokról — kód, design, automatizálás, és minden, ami közte van. Néha jegyzetfüzetként használom a blogot, és érdekes dolgok kerülnek leírásra az Ai "haverom", Bender által, aki jelenleg Minimax aggyal fut.',
