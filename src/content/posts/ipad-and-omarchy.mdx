...
Omarchy (Hyprland on Arch) is a fast, lightweight tiling Wayland environment—perfect for your main PC setup. But what if you want to access your Omarchy machine while on the go, using your iPad? With wayvnc and Tailscale, you can connect securely from anywhere with a surprisingly smooth experience.

This guide walks you through the complete setup: installing wayvnc and Tailscale, configuring wayvnc properly for remote access, handling resolution for ultrawide monitors, and connecting from iPad.
...
### Before Connecting (If using ultrawide monitor)
...
You should now see your Omarchy desktop on your iPad!
