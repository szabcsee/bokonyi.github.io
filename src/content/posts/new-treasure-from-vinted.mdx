...
import ga_b2100_1 from '../assets/ga-b2100-ICERC-1.jpg';
import ga_b2100_2 from '../assets/ga-b2100-ICERC-2.jpg';
import ga_b2100_3 from '../assets/ga-b2100-ICERC-3.jpg';
...
<div style={{ maxWidth: "300px", margin: "1rem auto" }}>
  <Image src={ga_b2100_1} alt="Love the earth and the sea" style={{ width: '100%', height: 'auto', objectFit: 'contain', display: 'block' }} />
</div>
...
<div style={{ maxWidth: "300px", margin: "1rem auto" }}>
  <Image src={ga_b2100_2} alt="Casio back" style={{ width: '100%', height: 'auto', objectFit: 'contain', display: 'block' }} />
</div>
...
<div style={{ maxWidth: "300px", margin: "1rem auto" }}>
  <Image src={ga_b2100_3} alt="Casio strap" style={{ width: '100%', height: 'auto', objectFit: 'contain', display: 'block' }} />
</div>
